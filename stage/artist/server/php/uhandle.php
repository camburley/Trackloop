...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		//mkdir("../../../uploads/albums/'$artistuniqueid'/'$albumsessionid'", 0755);
        $this->options = array(
            'script_url' => $this->get_full_url().'/uhandle.php',
            //'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
			'upload_dir' => '../../../../dev/uploads/albums/'.$artistuniqueid.'/'.$albumsessionid.'/',
            'upload_url' => '../../../../dev/uploads/albums/'.$artistuniqueid.'/'.$albumsessionid.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
