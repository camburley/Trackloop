...
foreach($artistalbums as $artistalbum)
{
	...
	$coverimage			=	$artistalbum->coverimage;
	$_SESSION['coverimage']	=	$artistalbum->coverimage;
}
}
...
<script type="text/javascript" src="../js/ajaxml/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="../js/ajaxml/jquery.hashchange.js"></script>
<script type="text/javascript" src="../js/ajaxml/ajaxml.js"></script>
...
.file-upload1 input.upload{position:absolute;top:0;right:0;margin:0;padding:0;font-size:20px;cursor:pointer;opacity:0;filter:alpha(opacity=0)}
       	...
       	<?php 
			//echo "../uploads/albums/".$artistuniqueid."/".$albumuniqueid."/coverimage/thumbnail/".$coverimage;
			if(file_exists("../uploads/albums/".$artistuniqueid."/".$albumuniqueid."/coverimage/thumbnail/".$coverimage))
			{
			//	echo "File Exists";
				$src	=	"../uploads/albums/".$artistuniqueid."/".$albumuniqueid."/coverimage/thumbnail/".$coverimage;
			}
			else
			{
          ...
          <span class="file-upload1 btn btn-success fileinput-button" onclick="removeimage()">
             <span>UPLOAD ALBUM COVER</span> 
              <input class="upload" type="file" action='uploadaction.php' name="coverimage">
          </span>
 
     
     <?php /*?> <span class="btn btn-success fileinput-button"> <span>UPLOAD ALBUM COVER</span> 
