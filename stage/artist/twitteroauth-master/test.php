...
$access_token['oauth_token']		=	"965485764-WK6MH3Y8vky8iv7YH0675TZQ8go6RtdR7m3KmT0B";
$access_token['oauth_token_secret']	=	"9IkUT8TTZFpiSow3YCetB5JBDVuI4bMO5h1qifsXFNM";
...
function twitteroauth_row($method, $response, $http_code, $parameters = '') {
	echo $method;
	//print_r($response->friends_count);
	 $_SESSION['totalfollowers']	=	$response->followers_count;
	 echo $totalfollowers			=	$response->followers_count;
  /*echo '<tr>';
...
//
///* statuses/show */
//$method = "statuses/show/965485764";
...
//
///* users/show */
//$method = 'users/show/965485764';
//twitteroauth_row($method, $connection->get($method), $connection->http_code);
//
///* users/search */
//$parameters = array('q' => 'amuqtadir88');
//twitteroauth_row('users/search', $connection->get('users/search', $parameters), $connection->http_code, $parameters);
//
///* statuses/friends */
//$method = 'statuses/friends/965485764';
//twitteroauth_row($method, $connection->get($method), $connection->http_code);
//
///* statuses/followers */
//$method = 'statuses/followers';
//twitteroauth_row('statuses/followers/965485764', $connection->get('statuses/followers/965485764'), $connection->http_code);
///********************total inforamation*******************/
$method	=	'users/show/'.$twitterid;
twitteroauth_row($method, $connection->get($method), $connection->http_code);
...
//
///* GET lists id */
//$method = "{$user->screen_name}/lists/27831060";
//twitteroauth_row($method, $connection->get($method), $connection->http_code);
//
///* DELETE list */
//$method = "{$user->screen_name}/lists/{$list->id}";
...
$totalfollowers	= $_SESSION['totalfollowers'];
