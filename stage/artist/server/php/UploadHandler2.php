...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
      $artistuniqueid	=	$_SESSION['artistuniqueid'];
        ...
        $this->options = array(
			...
			'upload_dir' => '../../../uploads/albums/'.$artistuniqueid.'/'.$albumsessionid.'/coverimage/',
            'upload_url' => '../../../uploads/albums/'.$artistuniqueid.'/'.$albumsessionid.'/coverimage/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'albumCoverupload',
            ...
            'inline_file_types' => '/\.(gif|jpeg|png|jpg)$/i',
    ...
    protected function trim_file_name($name,
        ...
        if (strpos($name, '.') === false &&
            preg_match('/^image\/(gif|jpeg|png|jpg)/', $type, $matches)) {
            $name .= '.'.$matches[1];
        }
        return $name;
    }
