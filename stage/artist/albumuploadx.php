...
<div class="successmsg"></div>
  ...
  <form id="fileupload" action="albumuploadaction.php?save=1" method="POST" enctype="multipart/form-data">
    ...
    <div class="track-upload span11">
      <div class="fileupload-buttonbar">
        ...
        <?php echo $_SESSION['filehandlealbumid']?>
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-upload fade">
        <td>
		 ...
		 <td>
            {% if (!o.files.error) { %}
                <?php //<div class="progress progress-success progress-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0"><div class="bar" style="width:0%;"></div></div>?>
            {% } %}
        </td>
		 <td>
            ...
            {% if (!i) { %}
                <button class="btn btn-warning cancel">
                    <?php /*?><i class="icon-ban-circle icon-white"></i><?php */?>
                    <span>X</span>
                </button>
            {% } %}
        </td>
