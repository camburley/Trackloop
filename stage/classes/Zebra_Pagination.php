...
class Zebra_Pagination
{
    ...
    function render($return_output = false)
    {
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li><a href="' . $this->_build_uri(1) . '" ' .
            ...
            $output .= '<li><a href="' . $this->_build_uri($this->_total_pages) . '" ' .
	...
	function getshow($setvalue)
	{
		$this->showrecord	=	$setvalue;
