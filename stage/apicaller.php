...
class ApiCaller
{
	private $_app_id	=	"BambooWebApp01";
	private $_app_key	=	"6783f2df5019b80d8a25bc198f14d326";
	public $_api_url	=	"http://localhost/gumption/trackloop/server/";
	
	function __construct()
	{
		if($_SERVER['HTTP_HOST']!='localhost')
		{
			$this->_api_url	=	"http://trackloop.fm/stage/server/";
		}
	}
